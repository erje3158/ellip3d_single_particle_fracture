...
int main(){
    ...
    long double x_min =-0.00045*10;
    long double x_max =+0.00045*10;
    long double y_min =-0.00045*10;
    long double y_max =+0.00045*10;
    long double z_min = 0.000;
    long double z_max =+0.0009;
    ...
    std::ofstream ofs("input_boundary_file");
    if(!ofs) {
